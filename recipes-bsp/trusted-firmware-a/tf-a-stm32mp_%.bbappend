...
do_sed_patch() {
    sed -i \
      ...
      mv ${S}/drivers/st/ddr/stm32mp_ddr_test.c ${S}/drivers/st/ddr/stm32mp_ddr_test.c.bak
      cp ${WORKDIR}/stm32mp_ddr_test.c ${S}/drivers/st/ddr/stm32mp_ddr_test.c
}
